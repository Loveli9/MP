package com.hyp.json.fastJson;

import java.util.ArrayList;
import java.util.Date;
import java.util.List;
import java.util.Map;
import com.hyp.json.fastJson.entity.Dept;
import com.hyp.json.fastJson.entity.Employee;
import com.hyp.json.fastJson.entity.Student;
...
public class FastjsonTest {
    ...
    public void test6() {
        ...
        emps.add(e2);
        //构造过滤器
        SimplePropertyPreFilter filter = new SimplePropertyPreFilter(Employee.class, "id", "name","age");
    ...
    public void test7(){
        ...
        //法一
        String empStr = JSON.toJSONStringWithDateFormat(emp, "yyyy年MM月dd日 HH时mm分ss秒");
