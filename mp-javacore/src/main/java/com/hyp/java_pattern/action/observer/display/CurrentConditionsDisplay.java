 ...
 * </html>
 */
package com.hyp.java_pattern.action.observer.display;
...
* @Description：   <p> CurrentConditionsDisplay 布告板  当前状况显示</p>
* @Author： - Jason   
...
public class CurrentConditionsDisplay implements ObserverInf, DisplayElement{
    ...
    private Subject5 weatherData;  //主题
    ...
    * @param weatherData
    */
    public CurrentConditionsDisplay(Subject5 weatherData){
