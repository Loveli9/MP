 ...
 * </html>
 */
package com.hyp.java_pattern.action.observer.display.subimpl;

import com.hyp.java_pattern.action.observer.display.ObserverInf;
import com.hyp.java_pattern.action.observer.display.subject.Subject5;
...
* @Description：   <p> WeatherData 天气数据</p>
* @Author： - Jason   
...
* @version    V1.0
*/
public class WeatherData implements Subject5 {
