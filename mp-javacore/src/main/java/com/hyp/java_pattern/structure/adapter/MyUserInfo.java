 ...
 * </html>
 */
package com.hyp.java_pattern.structure.adapter;

import com.hyp.java_pattern.structure.adapter.adapterAbs.IUserInfo;
...
public class MyUserInfo implements IUserInfo {
	...
	public String toString() {
		return "MyUserInfo [getUserName()=" + getUserName() + ", getHomeAddress()=" + getHomeAddress()
